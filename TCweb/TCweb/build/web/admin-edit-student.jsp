            ...
            <div class="row">
                <div class="col-sm offset-sm-2 col-md-6 offset-md-3 mt-5 pt-3 pb-3 bg-white from-wrapper">
                    <div class="container">
                        ...
                        <p><a href ="${pageContext.request.contextPath }/studentlistall" class="btn btn-secondary">&laquo; back to Student list</a></p>
                        ...
                        <p>
                            ...
                            #${student.address.id}</p>
                        <p>
                            <strong>Street:</strong><br>
                            ${student.address.street} </p>
                        <p>
                            <strong>House/apartment no:</strong><br>
                            ${student.address.houseNumber} </p>
                        <p>
                            <strong>City:</strong><br> 
                            ${student.address.city}</p>
                        <p>
                            <strong>Postcode:</strong><br>
                            ${student.address.postcode}  <br>
                    ...
                    <div class="container">
                        ...
                        <form action="admineditstudent" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type ="hidden" name="addressId" id="addressId" value="${student.address.id}"/>
