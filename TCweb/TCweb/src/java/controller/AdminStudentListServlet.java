...
public class AdminStudentListServlet extends HttpServlet {
 ...
 private static final long serialVersionUID = 1L;
  ...
  public AdminStudentListServlet(){
        super();
    }
...
//        
        Collection<Session> sessions = (Collection<Session>) session.getAttribute("sessions");
...
//            }
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("student-list-admin.jsp");
